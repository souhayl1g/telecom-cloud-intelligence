...
<required_reading>
@/home/souhayl/projects/telecom-cloud-intelligence/.claude/get-shit-done/references/ai-frameworks.md
@/home/souhayl/projects/telecom-cloud-intelligence/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/souhayl/projects/telecom-cloud-intelligence/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/souhayl/projects/telecom-cloud-intelligence/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/souhayl/projects/telecom-cloud-intelligence/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/souhayl/projects/telecom-cloud-intelligence/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/souhayl/projects/telecom-cloud-intelligence/.claude/agents/gsd-eval-planner.md for instructions.
