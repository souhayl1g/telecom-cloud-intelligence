...
```
Task(
  prompt="Read /home/souhayl/projects/telecom-cloud-intelligence/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/souhayl/projects/telecom-cloud-intelligence/.claude/get-shit-done/templates/SECURITY.md`
