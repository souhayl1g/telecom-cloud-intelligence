...
- **Global scope**: `/home/souhayl/projects/telecom-cloud-intelligence/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/souhayl/projects/telecom-cloud-intelligence/.claude/notes/`)
...
2. Glob `/home/souhayl/projects/telecom-cloud-intelligence/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/souhayl/projects/telecom-cloud-intelligence/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/souhayl/projects/telecom-cloud-intelligence/.claude/notes/` — works in any directory
