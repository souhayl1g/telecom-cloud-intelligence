...
export default function CommandPalette() {
    ...
    const commands: CommandItem[] = useMemo(() => [
        ...
        { id: "nav-granger", label: "Granger Causality", description: "OSS→BSS temporal causality analysis", group: "Pages", icon: CmdIcons.page, action: () => { router.push("/granger-causality"); close(); }, keywords: ["granger", "causality", "temporal", "lag", "oss", "bss"] },
        ...
        { id: "nav-health", label: "Ops Metrics", description: "Platform observability & health", group: "Pages", icon: CmdIcons.page, action: () => { router.push("/ops-metrics"); close(); }, keywords: ["health", "netdata", "prometheus", "grafana", "jaeger", "monitoring"] },
        ...
        { id: "ext-netdata", label: "Open Netdata", description: "Real-time system & container monitoring", group: "External Tools", icon: CmdIcons.external, action: () => { window.open("http://localhost:19999", "_blank"); close(); }, keywords: ["netdata", "monitoring", "metrics", "system", "real-time"] },
        { id: "ext-prometheus", label: "Open Prometheus", description: "Metrics explorer & TSDB", group: "External Tools", icon: CmdIcons.external, action: () => { window.open("http://localhost:9090", "_blank"); close(); }, keywords: ["prometheus", "metrics", "tsdb", "monitoring"] },
        { id: "ext-grafana", label: "Open Grafana", description: "Dashboards & visualization", group: "External Tools", icon: CmdIcons.external, action: () => { window.open("http://localhost:3000", "_blank"); close(); }, keywords: ["grafana", "dashboard", "visualization", "metrics", "monitoring"] },
        { id: "ext-jaeger", label: "Open Jaeger", description: "Distributed trace explorer", group: "External Tools", icon: CmdIcons.external, action: () => { window.open("http://localhost:16686", "_blank"); close(); }, keywords: ["jaeger", "tracing", "trace", "distributed", "observability"] },
        { id: "ext-otel", label: "Open OTel Collector", description: "OpenTelemetry OTLP HTTP endpoint", group: "External Tools", icon: CmdIcons.external, action: () => { window.open("http://localhost:4320", "_blank"); close(); }, keywords: ["otel", "opentelemetry", "collector", "otlp", "metrics", "4319", "4320"] },
