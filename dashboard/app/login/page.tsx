        ...
        <div className="login-page-root">
            ...
            <div className={`login-container ${success ? 'login-success-state' : ''}`}>
                ...
                <div className="login-brand">
                    <div className="login-brand-icon">
                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                            <rect width="48" height="48" rx="14" fill="url(#brand-gradient)" />
                    ...
                    <h1 className="login-title">AI Operations Agent</h1>
                    <p className="login-subtitle">Telecom Cloud Intelligence Platform</p>
                    <div className="login-level-badge">L4 Autonomous Network Operations</div>
                </div>
                ...
                <div className="login-switch">
                    ...
                    <a href="/signup" className="login-switch-link">Sign Up</a>
                </div>
