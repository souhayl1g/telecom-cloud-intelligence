        ...
        result.append(
            {
                ...
                "traffic_share_2g": (float(traffic_2g or 0) / traffic_total)
                if traffic_total
                else 0.0,
                "traffic_share_3g": (float(traffic_3g or 0) / traffic_total)
                if traffic_total
                else 0.0,
                "traffic_share_4g": (float(traffic_4g or 0) / traffic_total)
                if traffic_total
                else 0.0,
                "traffic_share_5g": (float(traffic_5g or 0) / traffic_total)
                if traffic_total
                else 0.0,
                ...
                if (
                    generation
                    and (
                        "4G" in generation.upper()
                        or "LTE" in generation.upper()
                        or "5G" in generation.upper()
                    )
                )
                else 0.0,
                "source": "real",
        ...
        result.append(
            {
                ...
                "active_users_max": int(active_users_max)
                if active_users_max is not None
                else None,
